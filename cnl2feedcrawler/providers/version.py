...
def create_version_file():
    ...
    version_info = [
        ...
        "        StringStruct(u'FileDescription', u'ClickNLoad2FeedCrawler'),",
        "        StringStruct(u'FileVersion', u'" + str(int(version_split[0])) + "." + str(
            int(version_split[1])) + "." + str(int(version_split[2])) + "." + str(int(suffix)) + "'),",
        "        StringStruct(u'InternalName', u'ClickNLoad2FeedCrawler'),",
        "        StringStruct(u'LegalCopyright', u'Copyright © RiX'),",
        "        StringStruct(u'OriginalFilename', u'ClickNLoad2FeedCrawler.exe'),",
        "        StringStruct(u'ProductName', u'ClickNLoad2FeedCrawler'),",
